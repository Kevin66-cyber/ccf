...
Author •• Boy Hamzah
FB     •• HamzaH Kirana
Github •• https://github.com/Boy-Aja
─────────────────────────────────────────────────────────"""
...
def menu():
	...
	print "─────────────────────────────────────────────────────────"
	print ('01.) Crack Semua Negara');time.sleep(0.07)
...
def pilih_indo():
	...
	print
	print "─────────────────────────────────────────────────────────"
	jalan('Masukan 3 Sandi Yang Kamu mau\n\t[ CONTOH ]\n\nSandi 1 •• Kontol\nSandi 2 •• ngentot\nSandi 3 •• ngewee\n')
	pass1 = raw_input(" Sandi 1 •• ")
	pass2 = raw_input(" Sandi 2 •• ")
	pass3 = raw_input(" Sandi 3 •• ")
	print "\n─────────────────────────────────────────────────────────"
        jalan ('\tJika Mau Membatal Kan Crack Tekan CTRL LALU Z')
	print "─────────────────────────────────────────────────────────\n"
